...
/**
 * Short description of class oat\taoItems\controller\form\Item
 *
 * @access public
 ...
 */
class Item extends InstanceForm
{
    /**
     * (non-PHPdoc)
    ...
    protected function initElements()
    {
        ...
        $elementId = tao_helpers_Uri::encode(ItemsService::PROPERTY_ITEM_MODEL);
