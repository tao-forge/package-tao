 ...
 */
class ItemPreview extends CommonModule
{
    ...
    public function forwardMe()
    {
        ...
        $lang = DEFAULT_LANG;
        $previewUrl = ItemsService::singleton()->getPreviewUrl($item, $lang);
    ...
    {
        $itemModel = $item->getOnePropertyValue($this->getProperty(ItemsService::PROPERTY_ITEM_MODEL));
        $impl = ItemsService::singleton()->getItemModelImplementation($itemModel);
        if (is_null($impl)) {
