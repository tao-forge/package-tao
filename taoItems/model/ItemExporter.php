...
abstract class ItemExporter
{
     ...
     *
     * @return oat\taoItems\model\ItemsService A TAO Item Service.
     */
    ...
    {
        try {
            return $this->getItem()->getUniquePropertyValue(new core_kernel_classes_Property(ItemsService::PROPERTY_ITEM_MODEL));
