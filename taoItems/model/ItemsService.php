...
use \common_Logger;
use \common_exception_EmptyProperty;
 ...
 * @package taoItems
 */
class ItemsService extends OntologyClassService
{
    /**
    ...
    public function getModelRuntime(core_kernel_classes_Resource $item)
    {
        ...
        if (!is_null($item)) {
            ...
            if (!is_null($itemModel)) {
                $returnValue = $itemModel->getOnePropertyValue($this->getProperty(itemModel::CLASS_URI_RUNTIME));
            }
        }
     ...
     * @param  Resource item
     * @return string
     * @throws oat\taoItems\model\ItemModelException
     */
     ...
     *
     * @return oat\taoItems\model\itemModel
    ...
    public function getItemModelImplementation(core_kernel_classes_Resource $itemModel)
    {
        ...
        if (!$itemModelService instanceof itemModel) {
