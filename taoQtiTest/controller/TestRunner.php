...
namespace oat\taoQtiTest\controller;
 ...
 * @package taoQtiTest
 * @deprecated old testrunner is deprecated. use oat\taoQtiTest\controller\Runner instead
 * @license GPLv2  http://www.opensource.org/licenses/gpl-2.0.php
 */
class TestRunner extends ServiceModule
{
     ...
     * @return oat\taoQtiTest\controller\TestRunner
     */
    ...
    protected function afterAction($withContext = true)
    {
        ...
        $ctx = TestRunnerUtils::buildAssessmentTestContext(
            $this->getTestSession(),
            $this->getTestMeta(),
            $this->getItemIndex(),
    ...
    protected function retrieveTestDefinition($qtiTestCompilation)
    {
        ...
        $testDefinition = Utils::getTestDefinition($qtiTestCompilation);
    ...
    protected function retrieveTestSession()
    {
        ...
        if ($qtiStorage->exists($sessionId) === false) {
            ...
            TestRunnerUtils::setInitialOutcomes($this->getTestSession(), $testTaker);
        } else {
        ...
        TestRunnerUtils::preserveOutcomes($this->getTestSession());
    }
    ...
    protected function retrieveItemIndex()
    {
        ...
        try {
            ...
            /** @var oat\tao\model\service\StorageDirectory $privateDirectory */
            $privateDirectory = $directories['private'];
            $data = $privateDirectory->read(QtiTestService::TEST_COMPILED_INDEX);
            if ($data) {
