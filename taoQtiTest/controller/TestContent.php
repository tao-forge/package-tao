...
use \tao_helpers_Http;
use oat\taoQtiTest\helpers\ResourceManager;
 ...
 * @package taoQtiTest
 */
class TestContent extends CommonModule
{
    /**
    ...
    public function files()
    {
        ...
        $data = ResourceManager::buildDirectory($test, $testLang, $subPath, $depth, $filters);
    ...
    public function upload()
    {
        ...
        $baseDir = ResourceManager::getBaseDir($test);
        ...
        $fileData = ResourceManager::buildFile($test, $testLang, $relPath . $fileName);
