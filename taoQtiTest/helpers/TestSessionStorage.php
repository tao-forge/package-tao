 ...
 *
 */
class TestSessionStorage extends AbstractQtiBinaryStorage implements ServiceManagerAwareInterface
{
    ...
    private function retrieveSessionInReadMode(AssessmentTest $test, string $sessionId): TestSession
    {
    ...
    private function retrieveSessionInWriteMode(AssessmentTest $test, string $sessionId): TestSession
    {
