...
use \tao_helpers_ServiceJavascripts;
...
class TestRunnerUtils
{
    ...
    public static function buildItemServiceCall(AssessmentTestSession $session, $testDefinitionUri, $testCompilationUri)
    {
        ...
        $testDefinitionResource = new core_kernel_classes_Resource(QtiTestService::INSTANCE_FORMAL_PARAM_TEST_DEFINITION);
        ...
        $testCompilationResource = new core_kernel_classes_Resource(QtiTestService::INSTANCE_FORMAL_PARAM_TEST_COMPILATION);
