 ...
 *
 */
class TestSession extends AssessmentTestSession
{
     ...
     * @throws oat\taoQtiTest\helpers\TestSessionException
     */
    protected function submitItemResults(AssessmentItemSession $itemSession, $occurence = 0)
    {
        ...
        try {
            ...
            throw new TestSessionException($msg, TestSessionException::RESULT_SUBMISSION_ERROR, $e);
     ...
     * @throws AssessmentTestSessionException
     * @throws oat\taoQtiTest\helpers\TestSessionException If the session is already ended or if an error occurs whil transmitting/processing the result.
     */
