...
class QtiTestConverter
{
    ...
    public function toArray()
    {
        try {
            ...
            throw new QtiTestConverterException('Unable to convert the QTI Test to json: ' . $re->getMessage());
        }
    }
    ...
    public function fromJson($json)
    {
        try {
            ...
            common_Logger::e($re->getMessage());
            common_Logger::d($re->getTraceAsString());
            throw new QtiTestConverterException('Unable to create the QTI Test from json: ' . $re->getMessage());
        }
    }
        ...
        foreach ($this->getProperties($reflector) as $property) {
            ...
            if ($value !== null) {
                ...
                if ($value instanceof QtiComponentCollection) {
                    ...
                    $array[$property->getName()] = TestRunnerUtils::getDurationWithMicroseconds($value);
