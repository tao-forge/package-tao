...
class QtiRunnerConfig extends ConfigurableService implements RunnerConfig
{
    ...
    protected function buildOptions(RunnerServiceContext $context)
    {
        ...
        $options = [
            'allowComment'      => TestRunnerUtils::doesAllowComment($session),
            'allowSkipping'     => TestRunnerUtils::doesAllowSkipping($session),
            'exitButton'        => TestRunnerUtils::doesAllowExit($session, $context),
            'logoutButton'      => TestRunnerUtils::doesAllowLogout($session),
            'validateResponses' => TestRunnerUtils::doesValidateResponses($session),
