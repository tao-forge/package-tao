...
class TestMapBranchRuleExtender
{
    ...
    const BRANCH_RULE_MAP_PAIRS = [
        [RunnerMap::MAP_ATTRIBUTE_PARTS, QtiTestService::XML_TEST_PART],
        [RunnerMap::MAP_ATTRIBUTE_SECTIONS, QtiTestService::XML_ASSESSMENT_SECTION],
        [RunnerMap::MAP_ATTRIBUTE_ITEMS, QtiTestService::XML_ASSESSMENT_ITEM_REF],
    ];
