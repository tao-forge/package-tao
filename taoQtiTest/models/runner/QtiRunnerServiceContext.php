...
class QtiRunnerServiceContext extends RunnerServiceContext
{
    ...
    /**
     * @var \oat\taoQtiTest\helpers\SessionManager
     */
    ...
    {
        $this->testDefinition = Utils::getTestDefinition($this->getTestCompilationUri());
    }
    ...
    protected function retrieveItemIndex()
    {
        ...
        try {
            ...
            $data = $directories['private']->read(QtiTestService::TEST_COMPILED_INDEX);
            if ($data) {
    ...
    /**
     * @return \oat\taoQtiTest\helpers\SessionManager
     * @throws \common_exception_Error
     * @throws \common_ext_ExtensionException
     */
