...
class SessionStateService extends ConfigurableService
{
     ...
     * @return string
     */
    public function getSessionDescription(TestSession $session)
    {
     ...
     * @param \oat\taoQtiTest\helpers\TestSession $session
     * @return array|bool
     */
    protected function getSessionProgress(TestSession $session)
    {
