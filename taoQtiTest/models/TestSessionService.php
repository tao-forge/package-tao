...
use oat\taoQtiTest\helpers\SessionManager;
...
class TestSessionService extends ConfigurableService implements DeliveryExecutionDelete
{
    ...
    protected function loadSession(DeliveryExecution $deliveryExecution, $forReadingOnly)
    {
        ...
        $sessionManager = new SessionManager($resultStore, $testResource);
        ...
        /** @var oat\taoQtiTest\helpers\TestSessionStorage $qtiStorage */
        ...
        /** @var \oat\tao\model\service\FileStorage $fileStorage */
        $fileStorage = $this->getServiceLocator()->get(FileStorage::SERVICE_ID);
     ...
     * @param \oat\taoQtiTest\helpers\TestSessionStorage $storage
     * @param array $compilationDirectories
     */
    public function registerTestSession(AssessmentTestSession $session, TestSessionStorage $storage, array $compilationDirectories)
    {
     ...
     * * 'storage': A oat\taoQtiTest\helpers\TestSessionStorage.
     ...
     * @return oat\taoQtiTest\helpers\TestSessionStorage|null
     * @throws QtiTestExtractionFailedException
     * @throws \common_Exception
     * @throws \common_exception_NotFound
     * @throws \common_ext_ExtensionException
    ...
    public function getRuntimeInputParameters(DeliveryExecution $deliveryExecution)
    {
        try {
            ...
            return ServiceCallHelper::getInputValues($runtime, []);
    ...
    public function deleteDeliveryExecutionData(DeliveryExecutionDeleteRequest $request)
    {
        ...
        try {
            ...
            if ($storage instanceof TestSessionStorage) {
