 ...
 *
 */
class QtiTestExporter extends ItemExporter
{
     ...
     *
     * @param oat\taoQtiTest\models\QtiTestService $service
     */
    protected function setTestService(QtiTestService $service)
    {
     ...
     *
     * @return oat\taoQtiTest\models\QtiTestService
     */
