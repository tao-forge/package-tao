...
class CatService extends ConfigurableService
{
     ...
     */
    public function getAssessmentItemRefByIdentifier(StorageDirectory $privateCompilationDirectory, $identifier)
    {
     ...
     */
    public function getAssessmentItemRefByIdentifiers(StorageDirectory $privateCompilationDirectory, array $identifiers)
    {
        $assessmentItemRefs = [];
     ...
     * @return array
     */
    public function getAssessmentItemRefsByPlaceholder(StorageDirectory $privateCompilationDirectory, AssessmentItemRef $placeholder)
    {
     ...
     * @param \oat\tao\model\service\StorageDirectory $compilationDirectory The compilation directory where the test is compiled as a TAO Delivery.
     ...
     */
    public function getAdaptiveAssessmentSectionInfo(AssessmentTest $test, StorageDirectory $compilationDirectory, $basePath, $qtiAssessmentSectionIdentifier)
    {
    ...
    public function getAdaptiveSectionMap(StorageDirectory $privateCompilationDirectory)
    {
        $dirId = $privateCompilationDirectory->getId();
        
        if (!isset($this->sectionMapCache[$dirId])) {
            $file = $privateCompilationDirectory->getFile(QtiTestCompiler::ADAPTIVE_SECTION_MAP_FILENAME);
    ...
    {
        return in_array(QtiTestCompiler::ADAPTIVE_PLACEHOLDER_CATEGORY, $assessmentItemRef->getCategories()->getArrayCopy());
    }
     ...
     * @return mixed
     */
    public function getCatSection(AssessmentTestSession $testSession, StorageDirectory $compilationDirectory, RouteItem $routeItem = null)
    {
    ...
    public function getCatEngine(AssessmentTestSession $testSession, StorageDirectory $compilationDirectory, RouteItem $routeItem = null)
    {
        $adaptiveSectionMap = $this->getAdaptiveSectionMap($compilationDirectory);
        $routeItem = $routeItem ? $routeItem : $testSession->getRoute()->current();
     ...
     * @return array
     */
    public function getPreviouslySeenCatItemIds(AssessmentTestSession $testSession, StorageDirectory $compilationDirectory, RouteItem $routeItem = null)
    {
        $result = [];
     ...
     * @return array
     */
    public function getShadowTest(AssessmentTestSession $testSession, StorageDirectory $compilationDirectory, RouteItem $routeItem = null)
    {
        $shadow = array_values(
            array_unique(
                array_merge(
     ...
     */
    public function getCatSession(AssessmentTestSession $testSession, StorageDirectory $compilationDirectory, RouteItem $routeItem = null)
    {
        if ($catSection = $this->getCatSection($testSession, $compilationDirectory, $routeItem)) {
     ...
     * @param RouteItem|null $routeItem
     */
    public function persistCatSession($catSession, AssessmentTestSession $testSession, StorageDirectory $compilationDirectory, RouteItem $routeItem = null)
    {
        if ($catSection = $this->getCatSection($testSession, $compilationDirectory, $routeItem)) {
            $catSectionId = $catSection->getSectionId();
    ...
    public function getCurrentCatItemId(AssessmentTestSession $testSession, StorageDirectory $compilationDirectory, RouteItem $routeItem = null)
    {
        $sessionId = $testSession->getSessionId();
    ...
    public function getCatAttempts(AssessmentTestSession $testSession, StorageDirectory $compilationDirectory, $identifier, RouteItem $routeItem = null)
    {
