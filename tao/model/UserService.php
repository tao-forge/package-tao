...
use \core_kernel_users_UsersManagement;
 ...
 * @package tao
 */
class UserService extends ConfigurableService implements core_kernel_users_UsersManagement
{
    ...
    {
        $triggered = false;
        $binder = new GenerisFormDataBinder($user);
