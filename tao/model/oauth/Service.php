...
use \common_http_SignatureService;
 ...
 * @deprecated
 */
class Service implements common_http_SignatureService
{
    /**
     ...
     * @access public
     * @author Joel Bout, <joel@taotesting.com>
     * @param mixed $authorizationHeader Move the signature parameters into the Authorization header of the request
     */
