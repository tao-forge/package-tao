...
use oat\tao\model\state\StateStorage as StateStorageInterface;
 ...
 * @package tao
 */
class StateStorage extends ConfigurableService implements StateStorageInterface
{
    /**
    ...
    {
        return ServiceManager::getServiceManager()->getServiceManager()->get(StateStorageInterface::SERVICE_ID);
    }
