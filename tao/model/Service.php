...
abstract class Service
{
    ...
    public static function getServiceByName($serviceName)
    {
        ...
        if (!$class->isSubclassOf('oat\\tao\\model\\Service')) {
            throw new common_exception_Error("$className must referr to a class extending the Service");
        }
