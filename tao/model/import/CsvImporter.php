 ...
 * @package tao
 */
class CsvImporter extends CsvAbstractImporter implements ImportHandler, ServiceLocatorAwareInterface, TaskParameterProviderInterface
{
     ...
     *
     * @return oat\tao\model\import\CSVMappingForm
    ...
    {
        $sourceContainer = new CsvUploadForm();
        ...
        $myFormContainer = new CSVMappingForm($values, [
    ...
    public function import($class, $form, $userId = null)
    {
        ...
        foreach ($rangedProperties as $propUri => $value) {
            if (strpos($propUri, CSVMappingForm::DEFAULT_VALUES_SUFFIX) !== false) {
                $cleanUri = str_replace(CSVMappingForm::DEFAULT_VALUES_SUFFIX, '', $propUri);
