...
use \tao_helpers_form_data_UploadFileDescription;
use oat\generis\model\fileReference\FileReferenceSerializer;
use oat\oatbox\service\ServiceManager;
use oat\tao\model\TaoService;
use oat\tao\model\upload\UploadService;

class GenerisFormDataBinder extends GenerisInstanceDataBinder
{
    /**
    ...
    public function bind($data)
    {
        ...
        try {
            ...
            throw new GenerisFormDataBindingException($msg);
        }
    ...
    protected function bindUploadFileDescription(
        ...
        elseif ($desc->getAction() == tao_helpers_form_data_UploadFileDescription::FORM_ACTION_ADD) {
            ...
            if (! empty($name) && ! empty($size)) {
                ...
                $serial = TaoService::singleton()->storeUploadedFile($source, $name);
