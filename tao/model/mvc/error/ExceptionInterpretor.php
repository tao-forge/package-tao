...
class ExceptionInterpretor implements ServiceLocatorAwareInterface
{
    ...
    protected function interpretError()
    {
        switch (get_class($this->exception)) {
            ...
            case MissingRequestParameterException::class:
