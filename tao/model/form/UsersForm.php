...
class UsersForm extends SignedFormInstance
{
    ...
    protected function initElements()
    {
        ...
        $langService = LanguageService::singleton();
        $userLangService = \oat\oatbox\service\ServiceManager::getServiceManager()->get(UserLanguageServiceInterface::class);
        if ($userLangService->isDataLanguageEnabled()) {
            ...
            $dataUsage = new core_kernel_classes_Resource(LanguageService::INSTANCE_LANGUAGE_USAGE_DATA);
            $dataOptions = [];
        ...
        $guiUsage = new core_kernel_classes_Resource(LanguageService::INSTANCE_LANGUAGE_USAGE_GUI);
        $guiOptions = [];
