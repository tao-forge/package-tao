...
class LanguagesTestCase extends TaoPhpUnitTestRunner
{
    ...
    public function testLanguagesExistence()
    {
        ...
        $languageClass = new core_kernel_classes_Class(LanguageService::CLASS_URI_LANGUAGES);
    ...
    public function testLanguageUsages()
    {
        ...
        $lgUsageProperty = new core_kernel_classes_Property(LanguageService::PROPERTY_LANGUAGE_USAGES);
        $this->assertIsA($lgUsageProperty, 'core_kernel_classes_Property');
        $this->assertEquals($lgUsageProperty->getUri(), LanguageService::PROPERTY_LANGUAGE_USAGES);
        $usagePropertyRange = $lgUsageProperty->getRange();
        $this->assertIsA($usagePropertyRange, 'core_kernel_classes_Class');
        $this->assertEquals($usagePropertyRange->getUri(), LanguageService::CLASS_URI_LANGUAGES_USAGES);
        ...
        $this->assertTrue(in_array(LanguageService::INSTANCE_LANGUAGE_USAGE_GUI, $usages));
        $this->assertTrue(in_array(LanguageService::INSTANCE_LANGUAGE_USAGE_DATA, $usages));
    }
}
