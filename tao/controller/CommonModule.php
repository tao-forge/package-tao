 ...
 *
 */
abstract class CommonModule extends LegacyController implements ServiceManagerAwareInterface, CommonModuleInterface
{
    ...
    /**
     * oat\tao\controller\CommonModule constructor.
     * @security("hide");
     */
