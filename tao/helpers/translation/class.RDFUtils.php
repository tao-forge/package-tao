...
class tao_helpers_translation_RDFUtils
{
    ...
    public static function createLanguageDescription($code, $label)
    {
        ...
        $languageType = LanguageService::CLASS_URI_LANGUAGES;
        ...
        $guiUsageNode->setAttributeNs($rdfNs, 'rdf:resource', LanguageService::INSTANCE_LANGUAGE_USAGE_GUI);
        $descriptionNode->appendChild($guiUsageNode);

        $dataUsageNode = $doc->createElementNS($base, 'tao:LanguageUsages');
        $dataUsageNode->setAttributeNs($rdfNs, 'rdf:resource', LanguageService::INSTANCE_LANGUAGE_USAGE_DATA);
        $descriptionNode->appendChild($dataUsageNode);
        
        $dataUsageNode = $doc->createElementNS($base, 'tao:LanguageOrientation');
        $dataUsageNode->setAttributeNs($rdfNs, 'rdf:resource', LanguageService::INSTANCE_ORIENTATION_LTR);
        $descriptionNode->appendChild($dataUsageNode);
